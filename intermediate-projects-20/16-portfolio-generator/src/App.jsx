export default function App(){
  ...
  const avatar = `https://api.dicebear.com/9.x/identicon/svg?seed=${encodeURIComponent(name)}`
  const html = `
  ...
  return (
    <div className="container">
      ...
      <div className="card" style={{marginTop:12}}>
        <iframe title="preview" style={{width:'100%',height:220,border:'none'}} srcDoc={html} />
      </div>
